...
export default function RoadExampleGallery({ onUseExample }) {
  ...
  return (
    <section className="example-gallery" aria-labelledby="road-examples-title">
      ...
      {isLoading && <p className="status-message" role="status">Loading backend examples…</p>}
